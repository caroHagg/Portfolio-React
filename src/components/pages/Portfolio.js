...
import doodledash from '../../Assets/Images/doodledash.png';
...
export default function Portfolio (){
    const projects =[
        ...
        {
            id:2,
            name: "Doodledash to have fun with friends",
            description:"Whats more fun than a drawing guessing game with friends",
